...
Try to do the same thing with a simple stan model to quantify the uncertainty in this ratio.
```{r}
library(rstan)
...
res_M13 = mrna_transport_inference_full(identifier = identifier,
