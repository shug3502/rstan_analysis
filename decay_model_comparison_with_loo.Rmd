...
r1 <- mrna_transport_inference_input_B(identifier='v105',use_real_data=TRUE,run_mcmc=TRUE,nSamples=15,nTest=5,
                                      parametersToPlot = c("theta","phi","sigma","gamma"),verbose=TRUE,
                                      show_diagnostic_plots=FALSE,compare_via_loo=TRUE)
loo_1 <- r1[[3]]
print(loo_1)
```
