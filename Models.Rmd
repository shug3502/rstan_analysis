...
```{r}
source('mrna_transport_full.R')
res1 = mrna_transport_inference_full('full_nu_uniform_v270',use_real_data = TRUE, run_mcmc = TRUE, nSamples = 8, nTest = 12, nTestOE = 7, verbose = TRUE, compare_via_loo = FALSE, show_diagnostic_plots = TRUE, use_hierarchical_model = FALSE, use_prior_predictive = FALSE, train_on_OE = FALSE, is_nu_uniform = TRUE)
