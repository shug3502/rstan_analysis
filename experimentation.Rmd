...
res_uniform = mrna_transport_inference_full('full_nu_uniform_v223',use_real_data = TRUE, run_mcmc = TRUE, nSamples = 6, nTest = 14, verbose = FALSE, compare_via_loo = TRUE, show_diagnostic_plots = FALSE, test_on_mutant_data = FALSE, is_nu_uniform = TRUE)

res_varying = mrna_transport_inference_full('full_nu_uniform_v224',use_real_data = TRUE, run_mcmc = TRUE, nSamples = 6, nTest = 14, verbose = FALSE, compare_via_loo = TRUE, show_diagnostic_plots = FALSE, test_on_mutant_data = FALSE, is_nu_uniform = FALSE)
