...
res_oe_blocked <- run_model_comparison_stst(identifier=identifier,use_real_data=TRUE,run_mcmc=FALSE,parametersToPlot = c('nu','xi','phi'),verbose=TRUE,show_diagnostic_plots=TRUE,compare_via_loo=TRUE, use_mixture_model=TRUE, train_on_OE=TRUE)
