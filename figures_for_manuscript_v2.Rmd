...
![optional caption text](plots/egg_chamber_stg4to6.png){ width=30% }
...
marginal_nu_by_pheno <- marginal_nu_comparison()
###############
library(patchwork)
h <- comparisons[[1]] + { {ggplot(data=NULL) + geom_blank() + theme_minimal()} + marginal_nu_by_pheno } + plot_layout(ncol=1,heights=c(2,1))
print(h)
ggsave(paste('plots/fig7',identifier,'.eps',sep=''),device=cairo_ps)
```
