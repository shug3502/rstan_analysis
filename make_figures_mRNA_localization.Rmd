...
![optional caption text](data/Example4/20170714_oocyte_stg6_phalloidin-488_grk-546_Z_02-1.png){ width=30% }
...
mrna_transport_sims_and_plot(identifier='v003',nSamples=15,nTest=5,th=c(2,2),sig=10^-9,phi=0.289,nu=0.95)
```
...
mrna_transport_inference_input_B(identifier='v055',use_real_data=TRUE,run_mcmc=FALSE,nSamples=15,nTest=5,parametersToPlot = c("theta","phi","sigma"),verbose=FALSE,show_diagnostic_plots=FALSE)
```
