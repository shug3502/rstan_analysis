...
run_model_comparison_stst(identifier='MCv057',use_real_data=TRUE,run_mcmc=FALSE,nSamples=15,nTest=5,parametersToPlot = c('nu','xi','phi'),verbose=FALSE,show_diagnostic_plots=TRUE,test_on_mutant_data=FALSE)
```
